        ...
        jdtls = function(_, opts)
          vim.api.nvim_create_autocmd("FileType", {
            ...
            callback = function()
              ...
              local workspace_dir = "/home/srch/dev/jdtls" .. project_name -- See `:help vim.lsp.start_client` for an overview of the supported `config` options.
              local config = {
                ...
                cmd = {
                  ...
                  "-jar",
                  vim.fn.glob(
                    "/home/srch/.local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_1.7.100.v20251111-0406.jar"
                  ),
                  -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
